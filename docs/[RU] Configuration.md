...
Настройка производится в формате: 
- `{"chance":Шанс,"vec":[Координаты],"ang":[Угол]}`
- `[{"vec":[Координаты],"ang":[Угол]},{"vec":[Координаты],"ang":[Угол]}]`
- `{"20":{"vec":[Координаты],"ang":[Угол]},"30":{"vec":[Координаты],"ang":[Угол]}}`
