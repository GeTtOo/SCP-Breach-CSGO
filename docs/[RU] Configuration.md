...
8. [Список команд](https://github.com/GeTtOo/SCP-Breach-CSGO/blob/main/docs/%5BRU%5D%20Configuration.md#914json3)
...
| gm status     | Вывести список команд и игроков в них в консоль |
...
| debug voice mute   | Отключение возможности игроку {1} слышать игрока {2} (id игрока) |
| debug voice unmute | Установка игроку {1} возможности слышать игрока {2} (id игрока) |
