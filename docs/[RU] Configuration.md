...
[^10]: 0 - Все перечисленный способы. 1 - Только консоль. 2 - Только файл. 3 - Только сторонние плагины (в случае, если вы используете Discord Logger, который входит в комплект, будет использоваться именно он).
